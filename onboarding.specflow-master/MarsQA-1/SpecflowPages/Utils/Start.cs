...
namespace MarsQA_1.Utils
{
    ...
    public class Start : Driver
    {
        ...
        public static void Beforerun()
        {
            ...
            _extentHtmlReporter = new ExtentHtmlReporter(@"C:\AdvancedTaskLevel1\onboarding.specflow-master\MarsQA-1\TestReports\Report1.html");
    ...
    public void CreateNode<T>() where T : IGherkinFormatterModel
    {
        ...
        {
            string name = @"C:\AdvancedTaskLevel1\onboarding.specflow-master\MarsQA-1\TestReports" + _scenarioContext.ScenarioInfo.Title.Replace(" ", "") + ".jpeg";
        ...
        {
            string name = @"C:\AdvancedTaskLevel1\onboarding.specflow-master\MarsQA-1\TestReports\Screenshots" + _scenarioContext.ScenarioInfo.Title.Replace(" ", "") + ".jpeg";
            CommonMethods.TakeScreenshot(driver, name);
